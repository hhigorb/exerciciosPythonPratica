"""
Considere a lista de produtos abaixo e implemente um programa que calcule e mostre na tela (nome e preço) o
produto mais caro e o produto mais barato, desta cesta de bens.
...
caro = max([produto['preco'] for produto in lista_compras])
barato = min([produto['preco'] for produto in lista_compras])

print(f'Produto mais caro: {caro}, produto mais barato: {barato}')
